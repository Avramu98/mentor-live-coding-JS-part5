...
let stringVariable = "orice fel de valoare in ghilimele";
let numberVariable = 24;
...
// console.log(typeof null); null pointer era o eroare in cod
...
let objectExample = {
   ...
   sayHello: function() { //METHOD
     console.log('hello from ES5 function', this.name)
   },
   sayHelloNew: () => {
      console.log('hello from ES6 function', this.name)
   },
   object: {
     newProperty: 'test'
   }   
...
// objectExample.sayHelloNew();
// const { name, age, booleanExample, sayHello } = objectExample;

// console.log(objectExample.name); // Vlad
// console.log(name); // Vlad
// console.log(objectExample.age);

let doSomethingWithObjectParam = (object) => {
    const { name, age, booleanExample, sayHello } = objectExample;
    // console.log(name);
    // console.log(object);
}

doSomethingWithObjectParam(objectExample);

let createCar = (carMake, carModel) => {
    return {
        carMake,
        carModel
    }
...
let car1 = createCar('VW', 'Golf');
let car2 = createCar('AUDI', 'A5');
let car3 = createCar('SKODA', 'Octavia');
...
//ARRAY
let arrayExample = [stringVariable, numberVariable, booleanVariable, doSomethingWithObjectParam, objectExample];
...
//PUNE PE ULTIMA POZITIE O VALOARE
// colorArray.push('brown');
// console.log(colorArray);

//PUNE PE O POZITIE SPECIFICA EX: PRIMUL ARGUMENT INDEXUL UNDE VREM SA FIE VALOAREA, CATE ELEMENT SA SCOATA, VALOAREA
// colorArray.splice(1, 0, 'brown')

// console.log(colorArray);

//SCOATE DE PE ULTIMA POZITIE
// colorArray.pop();
// console.log(colorArray);

//SCOATE DE PE POZITIE SPECIFICA PRIMUL ARG INDEXUL, CATE ELEMENT SA SCOATA
...
// for(let i=0; i<colorArray.length; i++) {
    //INFINITE LOOP
    // console.log('hello');
    // console.log(`This element ${colorArray[i]} is on index ${i}`);
// }
...
// .map returneaza un array nou
// let movieTitles = movies.map((movie) => {
//     return movie.title
// })

// .forEach nu returneaza nimic in schimb face orice instructiune
// let movieTitles = movies.forEach((movie) => {
...
// let movieInformation = movies.map((movie) => {
...
// let adventureMovies = movies.filter((movie) => {
//     return movie.genre.name === 'Adventure' && movie.release > '2015'
// })
...
// if(name === 'Vlad') {
//     console.log('this is true, name is Vlad');
// } else if (name === 'Avram') {
//     console.log('this is true, name is Avram');
// } else {
//     console.log('no condition matches')
// }


let checkIfTrue = () => {
    name === 'Vlad' ? console.log('this is true, name is Vlad') : console.log('this is false')
}
